...
class Ford_Ranger extends StatefulWidget {
  const Ford_Ranger({Key? key}) : super(key: key);

  @override
  State<Ford_Ranger> createState() => _Ford_RangerState();
}

class _Ford_RangerState extends State<Ford_Ranger> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/ford/ranger.png'),
                  height: 140,
                  width: 140,
