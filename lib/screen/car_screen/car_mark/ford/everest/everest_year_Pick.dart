...
import 'package:khmerautocolor/screen/car_screen/car_mark/ford/everest/everest_2017_2023_color_pick.dart';
import 'package:khmerautocolor/screen/car_screen/car_mark/toyota/corolla/Empty.dart';

class Everest extends StatefulWidget {
  const Everest({Key? key}) : super(key: key);
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/ford/everest.png'),
                  height: 140,
                  width: 140,

                  navigationTo: const everest_2017_2023_color_pick(),
