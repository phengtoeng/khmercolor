...
class Ranger_Xls extends StatefulWidget {
  const Ranger_Xls({Key? key}) : super(key: key);

  @override
  State<Ranger_Xls> createState() => _Ranger_XlsState();
}

class _Ranger_XlsState extends State<Ranger_Xls> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/ford/ranger_xls.png'),
                  height: 140,
                  width: 140,
