...
class Parthfinder extends StatefulWidget {
  const Parthfinder({Key? key}) : super(key: key);

  @override
  State<Parthfinder> createState() => _ParthfinderState();
}

class _ParthfinderState extends State<Parthfinder> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/nissan/parthfinder.png'),
                  height: 140,
                  width: 140,
