...
class Patrol extends StatefulWidget {
  const Patrol({Key? key}) : super(key: key);

  @override
  State<Patrol> createState() => _PatrolState();
}

class _PatrolState extends State<Patrol> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/nissan/patrol.png'),
                  height: 140,
                  width: 140,
