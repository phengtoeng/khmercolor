...
class Qashqai extends StatefulWidget {
  const Qashqai({Key? key}) : super(key: key);

  @override
  State<Qashqai> createState() => _QashqaiState();
}

class _QashqaiState extends State<Qashqai> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/nissan/qashqai.png'),
                  height: 140,
                  width: 140,
