...
import 'package:khmerautocolor/screen/car_screen/car_mark/nissan/almera/almera_2017_2023_color_pick.dart';
...
class Almera extends StatefulWidget {
  const Almera({Key? key}) : super(key: key);

  @override
  State<Almera> createState() => _AlmeraState();
}

class _AlmeraState extends State<Almera> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/nissan/almera.png'),
                  height: 140,
                  width: 140,

                  navigationTo: const almera_2017_2023_color_pick(),
