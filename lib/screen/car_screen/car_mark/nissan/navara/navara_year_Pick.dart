...
class Navara extends StatefulWidget {
  const Navara({Key? key}) : super(key: key);

  @override
  State<Navara> createState() => _NavaraState();
}

class _NavaraState extends State<Navara> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/nissan/navara.png'),
                  height: 140,
                  width: 140,
