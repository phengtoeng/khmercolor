...
class Xtrail extends StatefulWidget {
  const Xtrail({Key? key}) : super(key: key);

  @override
  State<Xtrail> createState() => _XtrailState();
}

class _XtrailState extends State<Xtrail> {
        ...
        builder: (BuildContext context, ScrollController scrollController) =>
          ...
          child: ListView(
            children: [
              ...
              Center(
                child: yearPickCar(
                  imageParth: Image.asset('lib/images/nissan/X-Trail.png'),
                  height: 140,
                  width: 140,
