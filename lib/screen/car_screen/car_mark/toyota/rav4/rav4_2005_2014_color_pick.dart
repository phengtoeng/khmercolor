...
class Rav4_2006_2014_Color_Pick extends StatefulWidget {
  ...
  @override
  State<Rav4_2006_2014_Color_Pick> createState() {
    return _Rav4_2006_2014_Color_PickState();
  }
}
class _Rav4_2006_2014_Color_PickState
    extends State<Rav4_2006_2014_Color_Pick> {
                              ...
                              Column(
                                children: [
                                  MaterialButton(
                                    ...
                                    child: Image.asset(
                                      'lib/images/toyota/color/6T3.png',fit: BoxFit.fill,
                                    ),
                                  ),
                                  const Text('Paint Code 6T3',style: const TextStyle(fontSize: 20,),)
                                ],
                              ),
                              Column(
                                children: [
                              ...
                              Column(
                                children: [
                                  MaterialButton(
                                    ...
                                    child: Image.asset(
                                      'lib/images/toyota/color/8S6.png',fit: BoxFit.fill,
                                    ),
                                  ),
                                  const Text('Paint Code 8S6',style: const TextStyle(fontSize: 20,),)
                                ],
                              ),
                              Column(
                                children: [
                                  MaterialButton(
                                    ...
                                    child: Image.asset(
                                      'lib/images/toyota/color/8R3.png',fit: BoxFit.fill,
                                    ),
                                  ),
                                  const Text('Paint Code 8R3',style: const TextStyle(fontSize: 20,),)
                                ],
                              ),
                              Column(
                                children: [
                              ...
                              Column(
                                children: [
                                  MaterialButton(
                                    ...
                                    child: Image.asset(
                                      'lib/images/toyota/color/4R4.png',fit: BoxFit.fill,
                                    ),
                                  ),
                                  const Text('Paint Code 4R4',style: const TextStyle(fontSize: 20,),)
                                ],
                              ),//blue
