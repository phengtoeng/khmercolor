...
class camry_2017_color_predawn_gray extends StatefulWidget {
  const camry_2017_color_predawn_gray({Key? key}) : super(key: key);

  @override
  State<camry_2017_color_predawn_gray> createState() => _camry_2017_color_predawn_grayState();
}

class _camry_2017_color_predawn_grayState extends State<camry_2017_color_predawn_gray>
          ...
          ListView(
            children: [
              ...
              Container(
                height: 150,
                width: 150,
                child: Image.asset('lib/images/toyota/camry/camry_2017_predawn.png'),
              ),
              // Container(
              //   height: 150,
              //   width: 150,
