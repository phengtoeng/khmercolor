...
class Code_6T8 extends StatefulWidget {
  const Code_6T8({Key? key}) : super(key: key);

  @override
  State<Code_6T8> createState() => _Code_6T8State();
}

class _Code_6T8State extends State<Code_6T8>
              ...
              Container(
                ...
                child: Table(
                  ...
                  children: [
                    ...
                    buildRow(['E10', '39.3', ]),
                    buildRow(['E36', '17.2(56.5)', ]),
                    buildRow(['E32', '14.7(71.2)', ]),
                    buildRow(['E71', '13(84.2)', ]),
                    buildRow(['E15', '11.3(95.5)', ]),
                    buildRow(['E47', '4.3(99.8)', ]),
                    buildRow(['E74', '1.1(100.9)', ]),
                    buildRow(['E48', '0.3(101.2)', ]),
                  ],
                ),
              ),
