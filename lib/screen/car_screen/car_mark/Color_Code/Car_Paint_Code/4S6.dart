...
class Code_4S6 extends StatefulWidget {
  const Code_4S6({Key? key}) : super(key: key);

  @override
  State<Code_4S6> createState() => _Code_4S6State();
}

class _Code_4S6State extends State<Code_4S6>
              ...
              Container(
                child: Table(
                  ...
                  children: [
                    ...
                    buildRow(['E13', '125.4', '188.1']),
                    buildRow(['E10', '28.8(154.2)','43.2(231.3)']),
                    buildRow(['E44', '27.6(181.8)', '41.5(272.8)']),
                    buildRow(['E48', '11.6(193.4)', '17.3(290.1)']),
                    buildRow(['E42', '5(198.4)', '7.6(297.7)']),
                  ],
                ),
              ),
