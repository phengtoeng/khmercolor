...
import 'package:khmerautocolor/screen/car_screen/car_mark/lexus/nx/nx_2015_2024_color_pick.dart';
import 'package:khmerautocolor/screen/car_screen/car_mark/toyota/corolla/Empty.dart';


class Nx extends StatefulWidget {
  const Nx({Key? key}) : super(key: key);

  @override
  State<Nx> createState() => _NxState();
}

class _NxState extends State<Nx> {
            ...
            Container(
              ...
              child: ListView(
                children: [
                  ...
                  Center(
                    child: yearPickCar(
                      imageParth: Image.asset('lib/images/lexus/Lexus_nx_sonic_quartz.png'),
                      height: 140,
                      width: 140,

                      navigationTo: nx_2015_2024_color_pick(),
